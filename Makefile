...
matrix.o: $(SRC_DIR)/matrix.cpp
	$(CC) $(FLAGS) $(INC) -c  $(SRC_DIR)/matrix.cpp -o $(BUILD_DIR)/matrix.o

utils.o: $(SRC_DIR)/utils.cpp
	$(CC) $(FLAGS) $(INC) -c  $(SRC_DIR)/utils.cpp -o $(BUILD_DIR)/utils.o

sbc_matrix.o: $(SRC_DIR)/sbc_matrix.cpp
	$(CC) $(FLAGS) $(INC) -c  $(SRC_DIR)/sbc_matrix.cpp -o $(BUILD_DIR)/sbc_matrix.o

init_functions.o: $(SRC_DIR)/init_functions.cpp
	$(CC) $(FLAGS) $(INC) -c $(SRC_DIR)/init_functions.cpp -o $(BUILD_DIR)/init_functions.o
